...
class NeuralClassifier(nn.Module):
    ...
    def __init__(self, data_helper, config):
        ...
        # Fine-tuning on GUM Experiment: load the finetuned SpanBERT
        self.tokenizer = BertTokenizer.from_pretrained("../data/finetuned-spanbert")
        self.bert = BertModel.from_pretrained("../data/finetuned-spanbert")
