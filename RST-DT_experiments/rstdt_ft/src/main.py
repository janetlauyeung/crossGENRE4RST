...
def get_train_loader(data_helper, config):
    ...
    action_labels = list(zip(data_helper.actions_numeric, data_helper.relations_numeric))
...
def train_model_coref(data_helper, config):
    ...
    os.makedirs("../data/model", exist_ok=True)     # make model dir if it doesn't exist
